...
parser.add_argument("--cam_path", default='../scripts/work_dir_voc_wseg/2024-07-11-08-59-27-750424/segs/logits/val', type=str, help="logit")
...
def crf_proc(args):
    ...
    results = joblib.Parallel(n_jobs=8, verbose=10, pre_dispatch="all")([joblib.delayed(_job)(i) for i in range(len(name_list))])
