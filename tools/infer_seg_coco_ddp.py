...
parser.add_argument("--model_path", default="../scripts/work_dir_coco_wseg/2024-08-05-21-43-10-054918/checkpoints/model_iter_80000.pth", type=str, help="model_path")
...
def _validate(pid, model=None, dataset=None, args=None):
    ...
    logging.info("\n" + format_tabs([seg_score], ["seg_pred"], cat_list=coco.class_list))
...
def crf_proc():
    ...
    logging.info("\n" + format_tabs([crf_score], ["seg_crf"], cat_list=coco.class_list))
    print(crf_score)
...
def validate(args=None):
    ...
    n_jobs = 1
    split_dataset = [torch.utils.data.Subset(val_dataset, np.arange(i, len(val_dataset), n_jobs)) for i in range (n_jobs)]
...
if __name__ == "__main__":
    ...
    setup_logger(filename=os.path.join('../scripts/work_dir_coco_wseg/2024-08-05-21-43-10-054918/segs',
                                       'test_pro4w1_5k_coco.log'))
