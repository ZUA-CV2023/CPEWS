...
parser.add_argument("--model_path", default="../scripts/work_dir_coco_wseg/2024-08-05-21-43-10-054918/checkpoints/model_iter_72000.pth", type=str, help="model_path")
...
# parser.add_argument("--data_folder", default='.../datasets/coco/MSCOCO/coco2014', type=str, help="dataset folder")
# parser.add_argument("--list_folder", default='../datasets/coco', type=str, help="train/val/test list file")
...
def _validate(model=None, data_loader=None, args=None):
    ...
    cam_dir = os.path.join(base_dir, "cam_img_bad", args.infer_set)
    cam_aux_dir = os.path.join(base_dir, "cam_img_aux_bad", args.infer_set)
