...
parser.add_argument("--model_path", default="../scripts/work_dir_voc_wseg/2024-07-11-08-59-27-750424/checkpoints/model_iter_20000.pth", type=str, help="model_path")
# parser.add_argument("--model_path", default="workdir_ablation_vitl-mmt/2022-11-08-21-09-54-870501/checkpoints/deit_base_patch16_224-b5f2ef4d.pth", type=str, help="model_path")
...
def  _validate(model=None, data_loader=None, args=None):
    ...
    logging.info("\n" + format_tabs([seg_score], [ "seg_pred"], cat_list=voc.class_list))
...
def crf_proc():
    ...
    logging.info("\n" + format_tabs([crf_score], [ "seg_crf"], cat_list=voc.class_list))
...
if __name__ == "__main__":
    ...
    setup_logger(filename=os.path.join('../scripts/work_dir_voc_wseg/2024-07-11-08-59-27-750424/segs', 'test_vit_pro_4bs_2w_train_vit.log'))
