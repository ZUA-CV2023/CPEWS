...
parser.add_argument("--list_folder", default='../datasets/voc', type=str, help="train/val/test list file")
parser.add_argument("--cam_folder", default='../scripts/work_dir_voc_wseg/2024-07-11-08-59-27-750424/segs/logits/val', type=str, help="logit")
...
if __name__=="__main__":
    ...
    for i in tqdm(eval_list, total=len(eval_list), ncols=100,):
        ...
        cls_labels = np.argmax(cams[0], axis=0)
